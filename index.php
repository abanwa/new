...
<body>
    ...
    <div class="address-bar">3ELIOGBOLO, RUMUOKORO, PORTHARCOURT,RIVERS STATE</div>


    <?php   //this displays when you log out.
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr class="visible-xs">
                    <p>Making the perfect cup of coffee can be challenging! with son many unique flavours and recipes to choose from, where do you begin? Our website provides you with the best recipes from around the world.Whether you prefer your coffee cold, mild or bracingly cold and strong - we are sure to have what you are looking for. For access to unlimited recipes you must register! Registration is free. Click here to get started!</p>
                </div>
            </div>
        </div>
